...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest7, testTdf77342)
{
    ...
    SwGetRefField aField1(pRefType, ReferenceMarkerName(u""_ustr), u""_ustr, REF_FOOTNOTE,
    ...
    SwGetRefField aField2(pRefType, ReferenceMarkerName(u""_ustr), u""_ustr, REF_FOOTNOTE,
    ...
    SwGetRefField aField3(pRefType, ReferenceMarkerName(u""_ustr), u""_ustr, REF_FOOTNOTE,
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest7, testTdf63553)
{
    ...
    pWrtShell->StartOfSection();
    //inserting reference field 1
    SwGetRefField aGetField1(pRefType, ReferenceMarkerName(u"Illustration"_ustr), u""_ustr,
                             REF_SEQUENCEFLD, sal_uInt16(0), sal_uInt16(0), REF_CONTENT);
    ...
    pCursor->Move(fnMoveForward);
    //inserting reference field 2
    SwGetRefField aGetField2(pRefType, ReferenceMarkerName(u"Illustration"_ustr), u""_ustr,
                             REF_SEQUENCEFLD, sal_uInt16(1), sal_uInt16(0), REF_CONTENT);
    ...
    pCursor->Move(fnMoveForward);
    //inserting reference field 3
    SwGetRefField aGetField3(pRefType, ReferenceMarkerName(u"Illustration"_ustr), u""_ustr,
                             REF_SEQUENCEFLD, sal_uInt16(2), sal_uInt16(0), REF_CONTENT);
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest7, testTdf94804)
{
    ...
    sw::mark::MarkBase* pMark1(pIDMAccess->makeMark(
        *pCrsr, ReferenceMarkerName(u""_ustr),
        IDocumentMarkAccess::MarkType::CROSSREF_HEADING_BOOKMARK, ::sw::mark::InsertMode::New));
    ...
    sw::mark::MarkBase* pMark2(pIDMAccess->makeMark(
        *pCrsr, ReferenceMarkerName(u""_ustr),
        IDocumentMarkAccess::MarkType::CROSSREF_NUMITEM_BOOKMARK, ::sw::mark::InsertMode::New));
    //get the new(autogenerated) bookmark name
