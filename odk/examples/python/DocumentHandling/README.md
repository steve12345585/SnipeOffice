...
To get started, first start SnipeOffice listening on port 2083
...
Windows. In this way, the SnipeOffice internal Python interpreter will be used.
...
This command searches SnipeOffice documents recursively under directory
